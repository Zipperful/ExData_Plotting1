...
plot(elecdata$TimeStamp, elecdata$Voltage, xlab="datetime", ylab="Voltage", type="l")
...
plot(elecdata$TimeStamp, elecdata$ReactivePwr, xlab="datetime", ylab="Global_reactive_power", type="l")
